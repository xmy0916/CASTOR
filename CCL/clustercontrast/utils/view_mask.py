...
def vis_maks(img_path, save_name, attention_mask, ratio=1, cmap="jet", save_image=False, quality=200):
    """
    ...
    if save_image:
        ...
        print("save image to: {}".format(save_name))
        plt.axis('off')
        plt.subplots_adjust(top=1, bottom=0, right=1, left=0, hspace=0, wspace=0)
        plt.margins(0, 0)
        plt.savefig(save_name, dpi=quality)
